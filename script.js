...
const birthdays = [
  ...
  { nickname: "Bren", month: 1, day: 18, color: "sun", phrase: "Diosa del amor egipcio" },
  { nickname: "Owi", month: 1, day: 31, color: "sky", phrase: "Grados celaius" },
  { nickname: "Gino", month: 2, day: 6, color: "aqua", phrase: "Te quieroooo" },
  { nickname: "Sola", month: 10, day: 11, color: "pink", phrase: "y bueno viejoo" },
  { nickname: "Sir", month: 10, day: 14, color: "blue", phrase: "Huevosss" },
  { nickname: "Gasty", month: 5, day: 13, color: "orange", phrase: "Tas volando" },
  { nickname: "Maru", month: 11, day: 24, color: "lavender", phrase: "Santiago malisimo motorizado" },
  { nickname: "Ori", month: 8, day: 18, color: "aqua", phrase: "<FRASE LESBIANA>" },
